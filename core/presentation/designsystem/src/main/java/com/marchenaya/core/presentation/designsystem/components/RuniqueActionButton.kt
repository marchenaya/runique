...
import com.marchenaya.core.presentation.designsystem.RuniqueBlack
...
@Preview
@Composable
private fun RuniqueActionButtonLoadingPreview() {
    RuniqueTheme {
        RuniqueActionButton(
            text = "My button",
            isLoading = true,
...
@Composable
private fun RuniqueActionOutlinedButtonPreview() {
    RuniqueTheme {
...
@Preview(showBackground = true, backgroundColor = 0xFF080707)
@Composable
private fun RuniqueOutlinedActionButtonLoadingPreview() {
    RuniqueTheme {
        RuniqueOutlinedActionButton(
            text = "My button",
            isLoading = true,
